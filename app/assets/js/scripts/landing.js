...
function updateSelectedServer(serv){
    ...
    ConfigManager.save()
    server_selection_button.innerHTML = '\u2022 ' + (serv != null ? serv.getName() : 'Sunucu Seçilmedi')
    if(getCurrentView() === VIEWS.settings){
...
const refreshMojangStatuses = async function(){
    loggerLanding.log('Mojang Durumları Yenileniyor..')
    ...
    try {
        ...
        loggerLanding.warn('Mojang hizmet durumu yenilenemiyor.')
...
const refreshServerStatus = async function(fade = false){
    ...
    try {
        ...
        loggerLanding.warn('Çevrimdışı varsayılarak sunucu durumu yenilenemiyor.')
        loggerLanding.debug(err)
    }
    if(fade){
    ...
    sysAEx.on('message', (m) => {
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    'Uyumlu<br>Java Kurulumu Bulunamadı',
                    'Oyuna katılmak için 64-bit Java 8 kurulumuna ihtiyacınız var. Bir kopyasını yüklememizi ister misiniz? Yükleyerek kabul etmiş olursunuz <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html">Oracle\'ın lisans sözleşmesi</a>.',
                    'Java\'yı yükleyin',
                    'Manuel olarak kur'
                )
                setOverlayHandler(() => {
                    setLaunchDetails('Java İndirme Hazırlanıyor..')
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            'Başlatmak için Java Gerekli<br>',
                            'Başlatmak için geçerli bir Java 8 x64 yüklemesi gerekir.<br><br>Lütfen <a href="https://github.com/favilances">Java Yönetim Kılavuzu</a> Java\'yı manuel olarak nasıl kuracağınıza ilişkin talimatlar için.',
                            'Anlıyorum',
                            'Geri dön'
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    ...
                    'Unfortunately we\'ve encountered an issue while attempting to install Java. You will need to manually install a copy. Please check out our <a href="https://github.com/favilances">Troubleshooting Guide</a> for more details and instructions.',
                    'I Understand'
                )
                setOverlayHandler(() => {
                    toggleOverlay(false)
            ...
            if(login && allGood) {
                ...
                const gameErrorListener = function(data){
                    ...
                    if(data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1){
                        ...
                        showLaunchFailure('Error During Launch', 'The main file, LaunchWrapper, failed to download properly. As a result, the game cannot launch.<br><br>To fix this issue, temporarily turn off your antivirus software and launch the game again.<br><br>If you have time, please <a href="https://github.com/favilances">submit an issue</a> and let us know what antivirus software you use. We\'ll contact them and try to straighten things out.')
                    }
                }
