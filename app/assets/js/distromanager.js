...
exports.pullRemote = function(){
    ...
    return new Promise((resolve, reject) => {
        const distroURL = 'https://favilances.xyz/distribution.json' // bu kısım launcher hangi sürümde hangi sunucuya bağlanıcağını gösteren distro dosyasın gereklidir kendi sitenize distro dosyası yükleyip linkini buraya koyun!
        const opts = {
            url: distroURL,
            timeout: 2500
        }
